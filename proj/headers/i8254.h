...
/* I/O port addresses */
#define TIMER_0    0x40 //!< I/O port addresses: Timer 0 count register 
#define TIMER_1    0x41 //!< I/O port addresses: Timer 1 count register 
#define TIMER_2    0x42 //!< I/O port addresses: Timer 2 count register 
#define TIMER_CTRL 0x43 //!< I/O port addresses: Control register 
...
#define TIMER_RB_COUNT_  BIT(5) //!< Read-back command format
#define TIMER_RB_STATUS_ BIT(4) //!< Read-back command format
#define TIMER_RB_SEL(n)  BIT((n) + 1) //!< Read-back command format
